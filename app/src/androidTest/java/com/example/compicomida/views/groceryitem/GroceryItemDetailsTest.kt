...
class GroceryItemDetailsTest {
    ...
    fun groceryItemDetailsTest() {
        ...
        val recyclerView2 = onView(
            allOf(
                withId(R.id.recyclerGroceryItems),
                childAtPosition(
                    withId(R.id.groceryItemsList),
                    1
                )
        ...
        val textView3 = onView(
            allOf(
                withId(R.id.item_name), withText("Patata"),
                withParent(
                    allOf(
                        withId(R.id.grocery_item_details),
        ...
        textView3.check(matches(withText("Patata")))

        val textView4 = onView(
            allOf(
                withId(R.id.item_category), withText("Verdura"),
                withParent(
                    allOf(
                        withId(R.id.grocery_item_details),
                        withParent(IsInstanceOf.instanceOf(android.widget.ScrollView::class.java))
        ...
        textView4.check(matches(withText("Verdura")))

        val textView5 = onView(
            allOf(
                withId(R.id.item_quantity), withText("Cantidad: 6.0 kg"),
                withParent(
                    allOf(
                        withId(R.id.grocery_item_details),
                        withParent(IsInstanceOf.instanceOf(android.widget.ScrollView::class.java))
        ...
        textView5.check(matches(withText("Cantidad: 6.0 kg")))

        val textView6 = onView(
            allOf(
                withId(R.id.item_price), withText("Precio: 4,00 € / kg"),
                withParent(
                    allOf(
                        withId(R.id.grocery_item_details),
                        withParent(IsInstanceOf.instanceOf(android.widget.ScrollView::class.java))
        ...
        textView6.check(matches(withText("Precio: 4,00 € / kg")))
    }
