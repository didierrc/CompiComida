...
class RemoveListTest {
    ...
    fun mainActivityTest() {
        ...
        textInputEditText.perform(replaceText("Lista a Eliminar"), closeSoftKeyboard())
        ...
        textView.check(matches(withText("Lista a Eliminar")))

        val appCompatImageButton = onView(
            allOf(
                withId(R.id.recycler_grocery_list_btn_delete),
                childAtPosition(
                    allOf(
                        withId(R.id.recycler_grocery_list_item),
                        childAtPosition(
        ...
        val viewGroup = onView(
            allOf(
                withId(R.id.recycler_grocery_list_item),
                withParent(withParent(withId(R.id.recyclerGroceryList))),
                isDisplayed()
            )
        )
